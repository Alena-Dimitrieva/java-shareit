...
class BookingServiceTest {
    ...
    private User owner() {
        return new User(2L, "Owner", "owner@mail.com");
    }
    ...
    private Booking bookingEntity() {
        ...
        booking.setBooker(new User(1L, "Booker", "booker@mail.com"));
    ...
    void createBooking_shouldThrow_whenBookingOwnItem() {
        ...
        when(userService.getUserById(2L)).thenReturn(new UserDto(2L, "Owner", "owner@mail.com"));
        when(itemService.getItemById(1L)).thenReturn(availableItem());
