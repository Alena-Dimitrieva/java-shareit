...
class CommentServiceTest {
    ...
    private Item item() {
        ...
        item.setOwner(new User(2L, "Bob", "bob@mail.com"));
        return item;
    }
    ...
    void addComment_shouldAddCommentSuccessfully() {
        when(userService.getUserById(1L))
                .thenReturn(new UserDto(1L, "Alice", "alice@mail.com"));
        ...
        Comment savedComment = new Comment(
                ...
                "Great item!",
                item(),
                new User(1L, "alice@mail.com", "alice@mail.com"),
                LocalDateTime.now()
        );
        ...
        assertEquals("alice@mail.com", result.getAuthorName());
    }
